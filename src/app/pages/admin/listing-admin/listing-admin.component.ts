...
import { AdminListingsService } from '../../../core/services/admin-listings/admin-listings.service';
...
@Component({
  selector: 'vojvoj-listing-admin',
  templateUrl: './listing-admin.component.html',
  styleUrl: './listing-admin.component.scss'
})
export class ListingAdminComponent implements OnInit {
  ...
  pageTitle: String = "List of Admins";
  ...
  async ngOnInit() {
    ...
    await this.adminListingsService.getAdminListing(this.authToken)
      .then((resp) => {
