...
@Component({
  selector: 'vojvoj-sidenav-tutor',
  templateUrl: './sidenav-tutor.component.html',
  styleUrl: './sidenav-tutor.component.scss'
})
export class SidenavTutorComponent implements OnInit {
    ...
    this.menuItems = [
      {
        label: "Dashboard",
        type: "route",
        routeTo: "/tutor-dashboard"
      },
      {
        label: "My Student Listing",
        type: "route",
